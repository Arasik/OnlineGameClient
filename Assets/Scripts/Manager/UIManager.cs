...
public class UIManager :BaseManager{
    ...
    //    }
    //}
    public UIManager(GameFacade gameFacade) : base(gameFacade) { ParseUIPanelTypeJson(); }
    ...
    private BasePanel GetPanel(UIPanelType panelType)
    {
        ...
        if (panel == null)
        {
            ...
            if (instPanel.GetComponent<BasePanel>() == null) Debug.LogWarning("basepanel is null"+ path);
